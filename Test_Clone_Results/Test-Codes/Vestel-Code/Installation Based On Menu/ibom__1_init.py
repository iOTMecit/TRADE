# COUNTRY: GERMANY
# Controls: testImages, checkAudio
# Live Signal: Vestel RF & SAT Diseqc
# Stream Player: DVB-C/T (DTA 111/115)

# Release Approval'in Profile'inin yuklemek yeterli
# Release Approval'in SatcoDX dosyasi olan USB disk kullanilmalidir
# Test sirasinda butun signaller kullanilmaktadir (Satellite, Terrestrial, Cable, Analogue)

# Controls: testImages, checkAudio
# Commands: STARTFTI, SETCOUNTRY GERMANY

# [DTV_DVB_C_346MHZ] "ModulationType DVBC 500" "Frequency 346 500" "BitRate 38014706 500" "Constellation QAM256 500" "remultiplex 1 500" "Play 1 500" 
# DTV_DVB_C_346MHZ = ['ModulationType; DVBC', 'Frequency; 346', 'BitRate; 38014706', 'Constellation; QAM256', 'remultiplex; 1', 'Play; 1']

import os
from customTime import sleep
from dll_Manual import Manual
from dll_DTA import DTA
...
dvbSettings = (1, 1, 1, 1)      # (Analogue, DVB-C, DVB-T, DVB-S)
...
WebMonitor_NewTest_dict = {
    ...
    'testName': 'INSTALLATION BASED ON MENU',   # Degistirmeyin
    'version': SWVersion,
    'SVN': SVNNumber,
    'pm': '',
    'romboot': '',
...
testSuiteName = 'Installation_Based_On_Menu'
