# DTA111 StreamPlayer ve VestelRF birlestirilmis yayini analog girise baglanmalidir.
# DTA107 StreamPlayer Satelitte girise baglanmalidir

# COUNTRY: GERMANY
# Controls: testImages
# Stream Player: DVB-T (DTA 111/115) & DVB-S (DTA 107)

# RNSController: Power & RC Keys
# UART: Sending Command, Reading Log

# Commands: GETCHANNELLIST, teletext_index, teletext_suppage
...
from dll_DTA107S import DTA107S
...
UIName = ''                     # 'carbon', 'titanium', 'panasonic', ...
...
WebMonitor_NewTest_dict = {
    ...
    'testName': 'TELETEXT',                 # Degistirmeyin
    'version': SWVersion,
    'SVN': SVNNumber,
    'pm': '',
    'romboot': '',
...
testSuiteName = 'Teletext'
deviceSettings = (2, 1, 1, 0, 1, 1)        # [imgCapDev, imgCompAlg, resizeCapture, rotateCapture, audCapDev, vidAnlDev]
