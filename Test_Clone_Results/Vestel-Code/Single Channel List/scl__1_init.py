# TV'ye Vestel-RF yayini ve Sat-Diseqc yayini baglanmalidir.
# Profil dosyasindan Service List Import/Export enabled yapilmalidir.
# Kanal listesinin bagli oldugu flash disk TV'ye takilmalidir.
# FTI, English, UK kurulum yapilip tum kanallar import edilmelidir.
# Profilden PowerUpMode LastState secilmelidir.

# COUNTRY: GERMANY, UK
# Controls: testImages, checkAudio, videoAnalysis -> HarranBoard
# Live Signal: Vestel RF & SAT Diseqc

# Commands: GETCHANNELLIST

# RNSController: Power & RC Keys
# UART: Sending Command, Reading Log
# External Memory (FAT32): 'IMPORT CHANNELLIST'
...
WebMonitor_NewTest_dict = {
    ...
    'project': projectName,
    'swType': 'Official',                           # '', 'Official', 'Nightly', 'Trial', 'Test'
    'hardware_name': hardwareName,
    'hardware': 'MB130 768MB',              # Orn: 'MB130 1.5GB', 'MB211 768MB'
    'testName': 'SINGLE CHANNEL LIST',      # Degistirmeyin
    'version': SWVersion,
    'SVN': SVNNumber,
    'pm': '',
    'romboot': '',
...
testSuiteName = 'Single_Channel_List'
deviceSettings = (2, 1, 1, 0, 3, 2)        # [imgCapDev, imgCompAlg, resizeCapture, rotateCapture, audCapDev, vidAnlDev]
